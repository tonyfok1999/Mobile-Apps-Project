...
import { IonList, IonItemSliding, IonItem, IonLabel, IonItemOptions, IonItemOption, IonIcon, IonNote, IonContent, IonHeader, IonMenu, IonRouterOutlet, IonTitle, IonToolbar } from '@ionic/react';
...
export const UncontrolledExample: React.FC = () => (
  <>
    <IonList>
      ...
      </IonItemSliding>      {/* Sliding item with expandable options on both sides */}
      <IonItemSliding>
        <IonItemOptions side="start">
          <IonItemOption color="danger" expandable>
            Delete
